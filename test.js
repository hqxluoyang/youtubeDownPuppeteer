...
async function start(id) {
    ...
    let ydata = await page.evaluate(async() => {
			...
			*/
				...
				//	}
					function ajaxGet(baseUrl, fun) {
						//let baseUrl = "https://www.youtube.com/watch?v=CZt-rVn2BJs"
					...
					function getBaseJS(body) { 
						...
						basejs = "https://www.youtube.com" + str
						console.log("base js:", basejs)
						//resolve(basejs)
					}
			
					function getInitResponse(body) {
						...
						adaptiveFormats = eval(str)
						// resolve(str)
						console.log("----------------basejs:----------------:", basejs)
						ajaxGet(basejs, function (b) {
							//console.log("解析出来的 basejshtml:", b)
							body = b
							start(b)
						})
